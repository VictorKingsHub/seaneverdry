...
import { Quote } from 'lucide-react'; // Assuming you have lucide-react for icons, if not, remove or replace

const testimonials = [
  {
    id: 1,
    name: 'Aisha K.',
    location: 'Lagos, Nigeria', // Added location for global feel
  ...
  },
  {
    ...
    review: "I've been using K19 for months, and I've noticed a significant improvement in my overall immunity. It's a natural way to stay healthy.",
    rating: 4,
  },
  {
    id: 4,
    ...
    review: "The USROLL elixir gave my skin a glow I haven't seen in years! It feels amazing knowing I'm nourishing my body with pure ingredients.",
    rating: 5,
  },
  {
    id: 5,
...
const TestimonialsSection: React.FC = () => {
  return (
    // Using a very light green background to maintain the brand's palette
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            ...
            >
              {/* Optional: Quote Icon */}
              <Quote className="text-green-600 w-10 h-10 mb-4" />

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
            Get in Touch with SeaNeverDry
          </h2>
          <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto">
            We&apos;re here to answer your questions, provide expert advice, and help you find the perfect natural solutions for your well-being.
          </p>
        </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-200"> {/* Enhanced shadow and border */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-lg"> {/* Increased spacing */}
              <Input
                ...
                className="text-lg p-3 border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md" // Improved focus styling
                required
              />
              <Input
                type="tel"
                name="phone"
                placeholder="Phone Number (e.g., +234 801 234 5678)" // Added example format
                value={form.phone}
                onChange={handleChange}
              ...
              <div className="flex items-start"> {/* Aligns icon and text */}
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    1 UKE STREET AREA 11 GARKI, ABUJA, NIGERIA
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a href="tel:+2348121718772" className="text-green-600 hover:text-green-800 transition-colors duration-200 text-lg flex items-center">
                        +234 812 171 8772
                      </a>
                    </li>
                    <li>
                      <a href="https://wa.me/2348033913721" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-800 transition-colors duration-200 text-lg flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    <a href="mailto:kingvic2553@gmail.com" className="text-green-600 hover:text-green-800 transition-colors duration-200">
                      kingvic2553@gmail.com
                    </a>
                  </p>
                </div>
              </div>

              {/* You can uncomment and add social media links here with relevant icons (e.g., FaFacebook, FaInstagram) */}
              {/* <div>
                <h4 className="text-xl font-semibold mb-2 text-gray-900">Follow Us</h4>
                <div className="flex space-x-4">
                  <a href="#" className="text-green-600 hover:text-green-800 text-2xl"><FaFacebook /></a>
                  <a href="#" className="text-green-600 hover:text-green-800 text-2xl"><FaInstagram /></a>
                  <a href="#" className="text-green-600 hover:text-green-800 text-2xl"><FaTwitter /></a>
                </div>
              </div> */}

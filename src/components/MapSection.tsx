...
const MapSection = () => {
  // The correct, long embed URL is now assigned to the variable for better code hygiene.
  const googleMapsEmbedUrl =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.3193266896674!2d7.49313977501056!3d9.034607288901167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0b8e38484b69%3A0xf8daab7dbe8ebaa6!2s1%20Uke%20St%2C%20Garki%2C%20Abuja%20900001%2C%20Federal%20Capital%20Territory!5e0!3m2!1sen!2sng!4v1753926940424!5m2!1sen!2sng";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full rounded-xl overflow-hidden shadow-2xl border-4 border-green-100">
          ...
          <iframe
            ...
            src={googleMapsEmbedUrl} // Now using the variable
            width="600"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
